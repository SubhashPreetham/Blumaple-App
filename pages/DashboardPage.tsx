...
const s = StyleSheet.create({
  page:{flex:1,backgroundColor:'#F5F5F5'},header:{minHeight:124,paddingHorizontal:40,paddingVertical:24,flexDirection:'row',alignItems:'center',justifyContent:'space-between',backgroundColor:'#FFFFFF',borderBottomWidth:1,borderColor:'#F5F5F5'},eyebrow:{color:'#3F72E5',fontSize:12,fontWeight:'800',letterSpacing:1.2},title:{marginTop:4,color:'#1A1C1D',fontSize:28,fontWeight:'800'},subtitle:{marginTop:4,color:'#2C2D2E',fontSize:14},status:{flexDirection:'row',alignItems:'center',gap:8,paddingHorizontal:12,paddingVertical:8,borderRadius:20,backgroundColor:'#F5F5F5'},statusDot:{width:8,height:8,borderRadius:4,backgroundColor:'#3F72E5'},statusText:{color:'#2C2D2E',fontSize:12,fontWeight:'700'},body:{width:'100%',maxWidth:1060,alignSelf:'center',padding:32,paddingBottom:80},menuRow:{gap:10,paddingBottom:28},menuButton:{paddingHorizontal:17,paddingVertical:10,borderRadius:8,backgroundColor:'#FFFFFF',borderWidth:1,borderColor:'#F5F5F5'},menuButtonActive:{backgroundColor:'#3F72E5',borderColor:'#3F72E5'},menuText:{color:'#2C2D2E',fontSize:14,fontWeight:'700'},menuTextActive:{color:'#FFFFFF'},panelHeader:{marginBottom:18,flexDirection:'row',alignItems:'flex-end',justifyContent:'space-between'},panelTitle:{color:'#1A1C1D',fontSize:22,fontWeight:'800'},panelCopy:{marginTop:5,maxWidth:650,color:'#2C2D2E',fontSize:14,lineHeight:20},count:{color:'#3F72E5',fontSize:13,fontWeight:'800'},slideList:{gap:14},slideCard:{minHeight:190,padding:18,borderRadius:14,flexDirection:'row',alignItems:'center',gap:22,backgroundColor:'#FFFFFF',borderWidth:1,borderColor:'#F5F5F5'},slideNumber:{position:'absolute',left:18,top:12,color:'#3F72E5',fontSize:10,letterSpacing:1,fontWeight:'800'},uploadTile:{width:142,height:142,marginTop:10,overflow:'hidden',borderRadius:10,justifyContent:'center',alignItems:'center',backgroundColor:'#F5F5F5',borderWidth:1,borderStyle:'dashed',borderColor:'#3F72E5'},uploadPreview:{width:'100%',height:'100%'},uploadPrompt:{marginTop:7,color:'#3F72E5',fontSize:12,fontWeight:'800'},fileInput:{position:'absolute',inset:0,opacity:0,width:'100%',height:'100%',cursor:'pointer'},details:{flex:1,minWidth:200,paddingTop:8},label:{marginBottom:6,color:'#1A1C1D',fontSize:12,fontWeight:'800'},input:{height:43,marginBottom:13,paddingHorizontal:12,borderWidth:1,borderColor:'#F5F5F5',borderRadius:7,color:'#2C2D2E',fontSize:14},select:{width:'100%',height:43,marginBottom:13,padding:12,borderWidth:1,borderColor:'#F5F5F5',borderRadius:7,color:'#2C2D2E',backgroundColor:'#FFFFFF',fontSize:14},remove:{alignSelf:'flex-start',flexDirection:'row',alignItems:'center',gap:5},removeText:{color:'#3F72E5',fontSize:12,fontWeight:'800'},actions:{flexDirection:'row',alignItems:'center',gap:12,marginTop:20},addButton:{height:46,paddingHorizontal:17,borderRadius:8,flexDirection:'row',alignItems:'center',gap:6,backgroundColor:'#FFFFFF',borderWidth:1,borderColor:'#3F72E5'},saveButton:{height:46,paddingHorizontal:17,borderRadius:8,flexDirection:'row',alignItems:'center',gap:6,backgroundColor:'#3F72E5'},saveButtonDisabled:{opacity:0.55},addText:{color:'#FFFFFF',fontSize:14,fontWeight:'800'},addOutlineText:{color:'#3F72E5',fontSize:14,fontWeight:'800'},note:{marginTop:16,color:'#2C2D2E',fontSize:12,lineHeight:17},error:{marginTop:10,color:'#B42318',fontSize:12,fontWeight:'700'},
});
