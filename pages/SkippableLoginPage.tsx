...
export function SkippableLoginPage({ loading, error, onLogin, onSkip }: { loading: boolean; error: string | null; onLogin: (identifier?: string, password?: string) => void; onSkip: () => void }) {
